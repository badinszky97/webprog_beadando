...
<div id="left"><p>A Lorem Ipsum egy egyszerû szövegrészlete, szövegutánzata a betûszedõ és nyomdaiparnak. A Lorem Ipsum az 1500-as évek óta standard szövegrészletként szolgált az iparban; mikor egy ismeretlen nyomdász összeállította a betûkészletét és egy példa-könyvet vagy szöveget nyomott papírra, ezt használta. Nem csak 5 évszázadot élt túl, de az elektronikus betûkészleteknél is változatlanul megmaradt. Az 1960-as években népszerûsítették a Lorem Ipsum részleteket magukbafoglaló Letraset lapokkal, és legutóbb softwarekkel mint például az Aldus Pagemaker.</p>
</div>
<div id="right"><dl>
    <dt><B>Piskóták</B></dt>
        <dd>Finom piskóták recepjeit olvashatod itt</dd>    
    <dt><b>Torták</B></dt>
        <dd>A legjobb tortákat is meg tudod sütni ezekkel a receptekekl.</dd> 
    <dt><b>Péksütemények</b></dt>
    <dd>Ha nincs kedved pékhez menni, vagy ha nem állsz szóba vele, süsd meg magadnak a kiflidet, kenyeredet!</dd> 
        <dt><b>Sós sütik</b></dt>
        <dd>Vendégvárás, gyerekzsúr, vagy céges konferencia? Sós süti nélkül nem elképzelhető!</dd> 
</dl></div>
</div>
